...
## 🐛 Bug fixes
- Fix: On mobile, multiple staff panel pages had overflowing elements that made an horizontal scrollbar appear (and brake the bottom navigation bar) (`d893119`)
